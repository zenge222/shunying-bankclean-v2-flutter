...
class BankOutletsSelect extends StatefulWidget {
  final int type;

  const BankOutletsSelect({Key key, this.type}) : super(key: key);
  @override
  _BankOutletsSelectState createState() => _BankOutletsSelectState();
}

class _BankOutletsSelectState extends State<BankOutletsSelect>
    with ComPageWidget {
  String searchName = "";
  List resList = [];
