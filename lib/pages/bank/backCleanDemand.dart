...
class BackCleanDemand extends StatefulWidget {
  final int outId;
  final String outStr;

  const BackCleanDemand({Key key, this.outId, this.outStr}) : super(key: key);

  @override
  _BackCleanDemandState createState() => _BackCleanDemandState();
}

/// 银行人员
class _BackCleanDemandState extends State<BackCleanDemand> with ComPageWidget {
...
//                                        transition: TransitionType.inFromRight);
          ...
          Container(
            ...
            child: FlatButton(
              ...
              /// _isDisabled
              onPressed: _images2.length == 0 || content == ''
                  ? null
                  : () {
                      _fromSubmit();
                    },
  ...
  void initState() {
    ...
    super.initState();
    print('outId:' + widget.outId.toString());
    print('outStr:' + widget.outStr);
  }
