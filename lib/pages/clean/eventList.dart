...
class _EventListState extends State<EventList> with ComPageWidget {
  List resList = [];
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          FlatButton(
            ...
            onPressed: () async{
              String outName = await SharedPreferencesUtil.getCleanBankName();
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => EventReport(outStr:outName),
                  )).then((data) {
                if (data == 'init') {
                  print('刷新list');
                  setState(() {
            ...
            return GestureDetector(
              onTap: () {
                Application.router.navigateTo(
                    context, Routers.eventDetail + '?id=${resList[index].id}',
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: Text(subTabsIndex==0?'待处理':'已处理',  style: TextStyle(
                    ...
                    Container(
                      margin: EdgeInsets.only(top: ScreenUtil().setHeight(20)),
                      child: Text('上报人：${resList[index].cleanerName}',
                          style: TextStyle(
                              fontSize: ScreenUtil().setSp(28),
                              color: ColorUtil.color('#666666'))),
                    ),
                    Container(
                      ...
                      child: Text('网点：${resList[index].organizationBranchName}',
                          style: TextStyle(
                              fontSize: ScreenUtil().setSp(28),
                              color: ColorUtil.color('#666666'))),
                    ),
