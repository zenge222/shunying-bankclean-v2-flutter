...
class EventReport extends StatefulWidget {
  ...
  const EventReport({Key key, this.outStr}) : super(key: key);
...
/// 保洁+？
class _EventReportState extends State<EventReport> with ComPageWidget {
...
//        PermissionGroup.location,
  ...
  Future _submitReport() async {
    ...
    Api.submitReport(map: params).then((res) {
      if (res.code == 1) {
        setState(() {
          isLoading = false;
        });
