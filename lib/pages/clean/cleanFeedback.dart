...
class CleanFeedback extends StatefulWidget {
  @override
  _CleanFeedbackState createState() => _CleanFeedbackState();
}
/// 保洁
// status 状态1：待分配，2：待处理，3:已处理
class _CleanFeedbackState extends State<CleanFeedback> with ComPageWidget {
  List resList = [];
...
//                            dateStr = timeStr;
//                            isGetAll = false;
//                            selDateTime = DateTime.parse(time);
//                          });
//                          _getMoreData();
//                        });
//                      },
            ...
            return GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          FeedbackDetail(id: resList[index].id),
                    )).then((data){
                    if(data=='init'){
                      setState(() {
                        pageNum = 1;
                    ...
                    Row(
                      ...
                      children: <Widget>[
                          ...
                          children: <Widget>[
                            Text('${resList[index].title}',
                                style: TextStyle(
                                    ...
                                    fontWeight: FontWeight.bold)),
                            Offstage(
                              offstage: resList[index].cleanerTimeout!=1,
                              child: Container(
                                margin: EdgeInsets.only(
                        ...
                        Container(
                          ...
                          child: Text(subTabsIndex == 0 ? '待处理' : '已处理',
                              style: TextStyle(
