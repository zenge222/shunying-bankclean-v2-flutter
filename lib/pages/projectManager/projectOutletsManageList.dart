...
class ProjectOutletsManageList extends StatefulWidget {
  @override
  _ProjectOutletsManageListState createState() =>
      _ProjectOutletsManageListState();
}
/// 项目经理
class _ProjectOutletsManageListState extends State<ProjectOutletsManageList>
    with ComPageWidget {
  String searchName = "";
          ...
          FlatButton(
            ...
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ProjectOutletsDistribute(
                    ),
                  )).then((data) {
                print('刷新列表');
              });
        ...
        itemBuilder: (BuildContext context, int index) {
          if (index == resList.length) {
            ...
            return GestureDetector(
              onTap: () {
                Application.router.navigateTo(context, Routers.projectOutletsManageDetail+'?id=${resList[index].id}',
                  ...
                  children: <Widget>[
                    Expanded(child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          margin:
                          EdgeInsets.only(top: ScreenUtil().setHeight(18),right: ScreenUtil().setWidth(40)),
