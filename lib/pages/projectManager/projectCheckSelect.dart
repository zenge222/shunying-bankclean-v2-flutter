...
class ProjectCheckSelect extends StatefulWidget {
  final int id;
  final int type;
  final int checkId;

  const ProjectCheckSelect({Key key, this.type, this.id, this.checkId}) : super(key: key);
  @override
  _ProjectCheckSelectState createState() => _ProjectCheckSelectState();
}
/// 项目经理+?
class _ProjectCheckSelectState extends State<ProjectCheckSelect>
    with ComPageWidget {
  String searchName = "";
  List<UserVO> resList = [];
        ...
        itemBuilder: (BuildContext context, int index) {
          if (index == resList.length) {
            ...
            return GestureDetector(
              onTap: () {
                Navigator.pop(context,resList[index]);
              },
              child: Container(
                  ...
                  children: <Widget>[
                    Row(
                      children: <Widget>[
                        ...
                        Text('${resList[index].phone}',style: TextStyle(
